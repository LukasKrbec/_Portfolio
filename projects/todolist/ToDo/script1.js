...
function saveData(){
    ...
    // console.log(data[0].children[0].value)
    // console.log(data[0].children[0].disabled)
    // if (localStorage.getItem("zaloha")===null){
    //     let pole = []
    ...
    // pole.push([data[0].children[0].value,data[0].children[0].disabled])
    pole = JSON.stringify(pole)
    localStorage.setItem("zaloha", pole)
    console.log(pole)
}
